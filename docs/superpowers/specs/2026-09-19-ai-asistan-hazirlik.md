...
- [ ] Xcode: `MARKETING_VERSION` 1.0 → 1.6, `CURRENT_PROJECT_VERSION` artır (pbxproj bu PR'da elle değiştirilmedi).
...
- [ ] `docs/APP_STORE_TR.md` / `EN.md` "What's New" metnine asistanı ekle.
- [ ] Gerçek cihazda ücretsiz model zincirini dene; `FreeModelCatalog.preferred` listesini o günkü ücretsiz modellere göre güncelle.
